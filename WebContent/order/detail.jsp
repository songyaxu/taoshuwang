...
<body>
        ...
        <table width="911" height="416" border="1" align="center">
          ...
          <tr>
		    <td height="230">订单状态:<s:if test="#request.order.state == 0">未付款</s:if>
